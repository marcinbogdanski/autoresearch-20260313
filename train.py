...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.ve_lambdas = nn.Parameter(torch.ones(config.n_layer))
        # Value embeddings
    ...
    def _precompute_rotary_embeddings(self, seq_len, head_dim, base=198750, device=None):
        if device is None:
    ...
    def _compute_window_sizes(self, config):
        ...
        for layer_idx in range(config.n_layer):
            ...
            if char == "L":
                ...
                short_window = early_short_window if layer_idx < num_early_local_layers else late_short_window
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=ve_scale_params, lr=scalar_lr * 0.2, betas=adam_betas, eps=1e-10, weight_decay=0.0),
    ...
    def forward(self, idx, targets=None, reduction='mean'):
        ...
        for i, block in enumerate(self.transformer.h):
            ...
            ve = self.ve_lambdas[i] * self.value_embeds[str(i)](idx) if str(i) in self.value_embeds else None
