...
class GPT(nn.Module):
    ...
    def num_scaling_params(self):
        ...
        lm_head = 0 if self.tie_word_embeddings else sum(p.numel() for p in self.lm_head.parameters())
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        lm_head_params = [] if self.tie_word_embeddings else list(self.lm_head.parameters())
